...
class _Avatar3DWidgetState extends State<Avatar3DWidget>
  ...
  late Animation<double> _burstFlash;
  late Animation<double> _burstParticle;
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final composition = _smoothedComposition / 100.0;
...
class _AvatarBodyPainter extends CustomPainter {
  ...
  void _drawHead(Canvas c, Size s, double cx, double h, double w, Color skin,
    ...
    final eyeH = isScanning ? headH * 0.14 : headH * 0.10;
